...
public class ReceiptTemplate implements SenderTemplate {
    ...
    protected ArrayList<HashMap<String, String>> elements =
            new ArrayList<HashMap<String, String>>();

    protected ArrayList<HashMap<String, String>> adjustments =
            new ArrayList<HashMap<String, String>>();
    ...
    public void setSummary(
            String subtotal, String shipping_cost, String total_tax, String total_cost) {
    ...
    public String build() {
        ...
        if (!this.address.isEmpty()) {
            ...
            if (!this.address.get("postal_code").equals("")) {
                this.message_string +=
                        "\"postal_code\":\"" + this.address.get("postal_code") + "\",";
            }
        ...
        if (!this.summary.isEmpty()) {
            ...
            if (!this.summary.get("shipping_cost").equals("")) {
                this.message_string +=
                        "\"shipping_cost\":" + this.summary.get("shipping_cost") + ",";
            }
