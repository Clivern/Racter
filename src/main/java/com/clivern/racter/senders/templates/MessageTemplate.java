...
public class MessageTemplate implements SenderTemplate {
    ...
    protected ArrayList<HashMap<String, String>> message_quick_replies =
    ...
    public String build() {
        ...
        if ((this.message_text != null)
                || (!this.message_attachment.isEmpty())
                || (!this.message_quick_replies.isEmpty())
                || (this.message_metadata != null)) {
            ...
            if (!this.message_attachment.isEmpty()) {
                this.message_string +=
                        "\"attachment\":{\"type\":\""
                                + this.message_attachment.get("type")
                                + "\",\"payload\":{\"url\":\""
                                + this.message_attachment.get("url")
                                + "\",\"is_reusable\": "
                                + this.message_attachment.get("is_reusable")
                                + "}},";
            }
